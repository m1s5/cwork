// OPCAutoServer.cpp
//
// (c) Copyright 1998-2000 The OPC Foundation
// ALL RIGHTS RESERVED.
//
// DISCLAIMER:
...
// 2.00  09/15/00 GK    Modified for integration with Batch Automation wrapper
//
//
...
//**************** Added for Batch
	hr = m_pOPCServer->QueryInterface(IID_IOPCBatchServer, (LPVOID*)&gpOPCBatchCustomServer);
	if (FAILED(hr))
